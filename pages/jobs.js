        ...
        {!isSubmitted ? (
          ...
          <>
            ...
            <div className="jgate" style={{ minHeight: 500 }}>
              <div className="jgate-blur">
                <div className="jg">
                  {(jobs.length >= 4 ? jobs.slice(0, 4) : jobs.length ? [...jobs, ...Array(4 - jobs.length).fill(null)].slice(0, 4) : [null,null,null,null]).map((job, i) => (
              ...
              <div className="jgate-box" style={{ padding: '40px 36px' }}>
                <div className="jgate-h" style={{ fontSize: 18, marginBottom: 20 }}>Sign in to see your matched jobs</div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                  <button className="jgate-btn" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, width: '100%', padding: '13px 20px', borderRadius: 10, fontSize: 14, background: '#fff', color: '#333', border: '1px solid #ddd' }} onClick={() => supabase.auth.signInWithOAuth({ provider: 'google', options: { redirectTo: window.location.origin + '/auth/callback' } })}>
                  ...
                  <button className="jgate-btn" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, width: '100%', padding: '13px 20px', borderRadius: 10, fontSize: 14, background: '#0A66C2', color: '#fff', border: 'none' }} onClick={() => supabase.auth.signInWithOAuth({ provider: 'linkedin_oidc', options: { redirectTo: window.location.origin + '/auth/callback', scopes: 'openid profile email' } })}>
