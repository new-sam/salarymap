...
const css = {
  ...
  docTitle: { fontSize: 26, fontWeight: 900, letterSpacing: '-0.02em', margin: '0 0 28px', color: 'var(--sm-gray-900)' },
  chapter: { marginBottom: 26 },
  chapterH: {
    fontSize: 16, fontWeight: 800, color: 'var(--sm-gray-900)', margin: '0 0 14px',
    paddingBottom: 8, borderBottom: '1px solid var(--sm-gray-100)',
  },
  article: { marginBottom: 16 },
  articleH: { fontSize: 14, fontWeight: 800, color: 'var(--sm-gray-800)', margin: '0 0 6px' },
  ...
  th: {
    ...
    background: 'var(--sm-gray-50)', border: '1px solid var(--sm-gray-200)', fontWeight: 800, color: 'var(--sm-gray-900)',
  },
