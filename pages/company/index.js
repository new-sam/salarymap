...
const STATUS_STYLE = {
  draft: { bg: 'var(--sm-gray-100)', color: 'var(--sm-gray-600)' },
  pending_review: { bg: 'var(--sm-primary-50)', color: 'var(--sm-primary-600)' },
  live: { bg: 'var(--sm-gray-100)', color: 'var(--sm-gray-900)' },
  paused: { bg: 'var(--sm-gray-100)', color: 'var(--sm-gray-600)' },
  closed: { bg: 'var(--sm-gray-100)', color: 'var(--sm-gray-400)' },
};
