      ...
      <div style={css.app}>
        ...
        <main style={css.main} className="!h-screen !overflow-hidden flex flex-col">
          ...
          <div className="flex-1 min-h-0 hidden md:flex flex-col">
            <div className="grid grid-cols-7 bg-[var(--sm-gray-50)] border border-[var(--sm-gray-200)] rounded-t-lg overflow-hidden flex-shrink-0">
              {[0,1,2,3,4,5,6].map(i => (
                <div
                  key={i}
                  className={cn(
            ...
            <div
              className="grid grid-cols-7 border-l border-r border-b border-[var(--sm-gray-200)] rounded-b-lg overflow-hidden bg-white flex-1 min-h-0"
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    !isFirstRow && 'border-t border-[var(--sm-gray-200)]',
                    !isRightEdge && 'border-r border-[var(--sm-gray-200)]',
