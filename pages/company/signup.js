...
const css = {
  ...
  noteText: { color: 'var(--sm-gray-700)' },
  field: { display: 'flex', flexDirection: 'column', gap: 7, marginBottom: 18 },
  label: { fontSize: 12.5, color: 'var(--sm-gray-700)', fontWeight: 600 },
  input: {
    background: '#fff', border: '1px solid var(--sm-gray-300)', borderRadius: 9,
    padding: '12px 14px', fontSize: 14, color: 'var(--sm-gray-900)',
    fontFamily: 'inherit', outline: 'none',
  },
  hint: { fontSize: 11.5, color: 'var(--sm-gray-400)' },
  err: {
    background: '#FEF2F2', border: '1px solid #FECACA', borderRadius: 8,
    padding: '10px 13px', fontSize: 12.5, color: '#dc2626', marginBottom: 14, lineHeight: 1.5,
  },
  googleBtn: {
    width: '100%', padding: '13px 16px', borderRadius: 10, border: '1px solid var(--sm-gray-300)',
    background: '#fff', color: 'var(--sm-gray-900)',
    fontSize: 14.5, fontWeight: 700, cursor: 'pointer',
    fontFamily: 'inherit',
    display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 10,
    marginBottom: 12,
  },
  legal: { fontSize: 11.5, color: 'var(--sm-gray-400)', textAlign: 'center', marginTop: 20, lineHeight: 1.7 },
  linkDim: { color: 'var(--sm-gray-600)', textDecoration: 'underline', fontWeight: 600, cursor: 'pointer' },
  linkAccent: { color: 'var(--sm-primary)', fontWeight: 700, cursor: 'pointer', textDecoration: 'underline' },
  bottomNav: {
