  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      setForm({
        ...
        // 급여 협의(0-0) 공고는 체크박스만 켜고 입력칸엔 기본값 노출 (체크 해제 시 바로 쓸 수 있게)
        salary_min: job.salary_min > 0 ? job.salary_min : 30000000,
        salary_max: job.salary_max > 0 ? job.salary_max : 50000000,
        salary_negotiable: !(job.salary_min > 0 && job.salary_max > 0),
