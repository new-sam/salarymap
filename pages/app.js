...
<nav>
  ...
  <div class="nav-r">
    ...
    <a class="nav-btn" href="${APP_STORE_URL}" target="_blank" rel="noopener noreferrer">${t('app.nav.download')}</a>
  </div>
</nav>
...
<section class="hero">
  ...
  <div class="dl-row reveal" style="--d:.32s">
    <a class="dl-btn js-app-dl" href="${APP_STORE_URL}" target="_blank" rel="noopener noreferrer">
