...
<div class="cards-section">
  <div class="section-head">
    <h2 class="section-head-title">Xem các công ty IT hàng đầu Việt Nam <em>trả lương bao nhiêu.</em></h2>
    <p class="section-head-sub">Tìm công ty của bạn hoặc duyệt theo danh mục.</p>
  </div>
...
<div id="full-feed">
  <div class="ff-head">
    ...
    <div class="ff-meta" id="ff-meta">134 công ty · 4.812 dữ liệu lương</div>
  </div>
  <div class="card-grid">
...
function fire(){
  ...
  if(ne){ ne.textContent=\`\${nv[idx]} dữ liệu lương\`; ne.style.color='var(--orange)'; setTimeout(()=>ne.style.color='var(--dim)',800); }
  addTicker(d);
}
    ...
    if (data.found) {
      ...
      body.innerHTML = \`
        <div class="co-no-data">
          ...
          <div class="co-no-data-sub">Hãy là người đầu tiên gửi lương và mở khóa dữ liệu.</div>
          <button class="btn-sub" onclick="document.querySelector('.submit-outer').scrollIntoView({behavior:'smooth'})">Gửi lương của tôi →</button>
        </div>
