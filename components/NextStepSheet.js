            ...
            {[
              ...
              <div key={c.id}
                ...
                <div className="ns-card-body">
                  <button className={`ns-btn${!c.blue ? ' gray' : ''}${selected === c.id ? ' active' : ''}`}
                    dangerouslySetInnerHTML={{ __html: c.label.replace(/\n/g, '<br/>') }} />
                ...
                {jobCount > 0 && (
                  <div className="ns-jobs-preview">
                      ...
                      {jobs.map((job, i) => {
                        ...
                        return (
                          <div key={i} className={`ns-jp${i === 2 ? ' ns-jp-half' : ''}`}>
                            <div className="ns-jp-img" style={{ background: bgColors[i % 3] }}>
                              <div className="ns-jp-logo">{ini}</div>
                            </div>
                    ...
                    <div className="ns-overlay">
                      <div className="ns-overlay-icon">🔒</div>
                      <div className="ns-overlay-text">Sign in to see & apply</div>
                    </div>
