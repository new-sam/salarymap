      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        {!earned && detail.ctaLabel && detail.onCta && (
          <button type="button" onClick={() => { detail.onCta?.(); onClose() }}
            style={{ alignSelf: 'stretch', border: 'none', cursor: 'pointer', fontFamily: 'inherit', background: '#ff4400', color: '#fff', borderRadius: 16, padding: '17px 0', marginTop: 14, fontSize: 16, fontWeight: 800 }}>
            {detail.ctaLabel}
          </button>
        )}
      </div>
