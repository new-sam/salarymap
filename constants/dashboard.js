export const T = {
  ko: {
    ...
    metrics: {
      ...
      resumeUploads: '이력서 등록', cvSuccessApps: 'CV 등록→원탭 지원', jobAppsCompany: '채용 공고 지원(기업등록)',
    },
  ...
  en: {
    ...
    metrics: {
      ...
      resumeUploads: 'Resume uploads', cvSuccessApps: 'CV one-tap apply', jobAppsCompany: 'Job applications (company)',
    },
