...
※ "인건비가 저렴하다" 류 훅은 절대 쓰지 말 것(이미 앎). 아래 구조·내용을 자연스러운 한국어 존댓말로, 담백하게.
...
- 그다음 자연스럽게 "베트남에서 인재 채용하실 일이 있으실 텐데" 식으로 아래 제안으로 연결.

[핵심 — 짧게. 상세 수치·비교는 바로 아래 이미지가 보여주므로 텍스트로 중복 나열하지 말 것]
- 한두 문장으로만: 저희 FYI는 공고 등록부터 인터뷰까지 무료이고, 채용에 성공하셨을 때만 비용이 발생합니다("No Hire, No Pay"). 안 뽑히면 비용도 없습니다.
- 그다음 줄에 정확히 "[[IMAGE]]" 한 줄만 단독 출력할 것. (No Hire No Pay 비교·수수료·지표 비주얼이 자동으로 들어가는 자리 — 이 표시는 변형·설명하지 말고 그대로 둘 것)

[CTA — 이미지 다음]
"이번 달 채용 예정인 포지션이 있으실까요? 첫 공고는 무료로 올려드리겠습니다. 관심 있으시면 이 메일에 회신 주세요."

[마무리]
"감사합니다." 줄바꿈 후 "위승주 드림".

- 블록 사이 빈 줄. 과장/스팸성 표현 금지.
- 제목 30자 이내(택1 느낌): "채용 성공 시에만 비용" 리스크 강조형, 또는 "게재비 받는 다른 플랫폼과 달리 채용 시에만" 비교형. 낚시성 금지.
${COMMON_RULES}`,
  },
