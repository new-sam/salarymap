...
// 브랜드 오렌지 — #ff4400 기준 스케일 (사이트 전역 액센트와 동일).
const orange = {
  50:  '#FFF7F5',
  100: '#FFF2EC',
  200: '#FFD6C8',
...
export const color = {
  ...
  // 단일 소스인 globals.css의 --sm-* 토큰을 참조한다 (DOM 스타일 전용).
  bg:        'var(--sm-bg-warm)',
  surface:   'var(--sm-surface)',   // 카드 배경
  border:    'var(--sm-line-strong)',
  divider:   'var(--sm-line)',
  ...
  brand:     'var(--sm-accent)',
  brandDeep: 'var(--sm-accent-strong)',
};

// var() 불가 지점 전용 리터럴 채널 — 이메일 HTML, 차트, 색 연산(rgba 합성 등).
// DOM 스타일에는 color.* alias를 쓸 것.
export const hex = {
  accent: '#FF4400',
  accentStrong: '#E63D00',
  ink: '#111111',
