...
const orange = {
  ...
  300: '#FFA07F',
  400: '#FF6B35',
  500: '#FF4400',  // 브랜드 메인 (본 사이트 #ff4400과 동일)
  600: '#E03C00',
  700: '#B83100',
  800: '#8F2600',
  900: '#701E00',
...
// 뉴트럴 그레이 — 본 사이트(#111/#444/#888)와 동일한 무채색 톤.
const gray = {
  0:   '#FFFFFF',
  50:  '#FAFAFA',  // 배경
  100: '#F5F5F5',  // 카드 hover, subtle bg
  200: '#E8E8E8',  // 보더, 디바이더
  300: '#D6D6D6',
  400: '#B0B0B0',  // 비활성 텍스트
  500: '#8C8C8C',  // placeholder
  600: '#666666',  // 보조 텍스트
  700: '#444444',  // 본문 (light 모드)
  800: '#2A2A2A',  // 강한 텍스트
  900: '#111111',  // 제목 / 최강 텍스트
};
...
export const font = {
  ...
  weight: {
    // 어드민 대시보드 기준으로 한 단계씩 낮춘 스케일 — 600 기본, 700 강조,
    // 800은 큰 숫자 정도만. (기존 800/900 남발이 과장돼 보인다는 피드백)
    regular: 400,
    medium:  500,
    semi:    600,
    bold:    700,
...
export const badgeTone = {
  brand:   { background: color.primary[100], color: color.primary[500] },
