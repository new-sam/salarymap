...
export const STATUS_PUSH = {
  ...
  docs_passed: {
    vi: 'Chúc mừng! Bạn đã vượt qua vòng hồ sơ',
    ko: '서류 전형에 합격했습니다',
    en: 'You passed the document screening',
  },
  interview: {
    vi: 'Bạn có thư mời phỏng vấn — hãy kiểm tra email',
    ko: '면접 안내가 도착했습니다. 이메일을 확인해주세요',
    en: 'Interview invitation sent — check your email',
  },
  decided: {
