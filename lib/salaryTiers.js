...
export const SALARY_TIERS = [
  { key: 'nghindo', min: 25000000, defaultLabel: 'Nghìn đô (월25M+)', color: '#2563eb', grad: 'linear-gradient(135deg,#60a5fa,#2563eb)' },
  { key: 'tienty',  min: 85000000, defaultLabel: 'Tiền tỷ (월85M+)',  color: '#b45309', grad: 'linear-gradient(135deg,#fbbf24,#d97706)' },
]
