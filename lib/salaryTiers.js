...
export const SALARY_TIERS = [
  { key: 'nghindo',  min: 25000000,  defaultLabel: '천달러 (월 25M+)',      enLabel: '$1K/mo (25M+)',    color: '#2563eb', grad: 'linear-gradient(135deg,#60a5fa,#2563eb)' },
  { key: 'nghindo2', min: 50000000,  defaultLabel: '2천달러 (월 50M+)',     enLabel: '$2K/mo (50M+)',    color: '#7c3aed', grad: 'linear-gradient(135deg,#a78bfa,#7c3aed)' },
  { key: 'tienty',   min: 85000000,  defaultLabel: '억대·연10억동 (월 85M+)', enLabel: '1 tỷ/yr (85M+)',   color: '#b45309', grad: 'linear-gradient(135deg,#fbbf24,#d97706)' },
  { key: 'tienty2',  min: 167000000, defaultLabel: '연 20억동 (월 167M+)',   enLabel: '2 tỷ/yr (167M+)',  color: '#be123c', grad: 'linear-gradient(135deg,#fb7185,#be123c)' },
  { key: 'tienty3',  min: 250000000, defaultLabel: '정점·연30억동 (월 250M+)', enLabel: '3 tỷ/yr (250M+)',  color: '#0e7490', grad: 'linear-gradient(135deg,#67e8f9,#3b82f6,#8b5cf6)' },
]
...
// 커뮤니티에 표시할 연봉 등급 키를 결정한다. 옵트인 방식: 사용자가 명시적으로 고른
// 대표 등급(representativeTier)이 본인 실제 획득 등급 이하인 유효한 등급일 때만 그것을
// 노출하고, 미선택(null)이거나 무효면 아무 뱃지도 노출하지 않는다(비공개가 기본값).
export function resolveDisplayTier(amountVnd, representativeTier) {
  const actual = getSalaryTier(amountVnd)
  if (!actual || !representativeTier) return null
